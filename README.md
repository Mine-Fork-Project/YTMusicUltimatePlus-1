...
## How to build a YTMusicUltimatePlus IPA by yourself using Github actions
...
3. Go to the Actions tab on your forked repo, click on "Build and Release YTMusicUltimatePlus" located on the left side. Click "Run workflow" button located on the right side.
...
3. Cd your YTMusicUltimatePlus folder and run:
